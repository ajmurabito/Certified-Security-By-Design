...
sig
  ...
  val exam3_grammars : type_grammar.grammar * term_grammar.grammar
(*
   [aclDrules] Parent theory of "exam3"

   [cipher] Parent theory of "exam3"
   ...
   [roles_case_def]  Theorem
      ...
      |- (∀v0 v1. (case Employee of Employee => v0 | Relay => v1) = v0) ∧
