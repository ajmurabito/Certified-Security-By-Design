\newcommand{\HOLcryptoExercisesDate}{07 March 2020}
\newcommand{\HOLcryptoExercisesTime}{04:09}
\begin{SaveVerbatim}{HOLcryptoExercisesTheoremsexerciseOneFiveXXSixXXOneaXXthm}
\HOLTokenTurnstile{} \HOLSymConst{\HOLTokenForall{}}\HOLBoundVar{keyk} \HOLBoundVar{enMsg} \HOLBoundVar{message}.
     (\HOLConst{deciphS} \HOLFreeVar{key} \HOLBoundVar{enMsg} \HOLSymConst{=} \HOLConst{SOME} \HOLBoundVar{message}) \HOLSymConst{\HOLTokenEquiv{}}
     (\HOLBoundVar{enMsg} \HOLSymConst{=} \HOLConst{Es} \HOLFreeVar{key} (\HOLConst{SOME} \HOLBoundVar{message}))
\end{SaveVerbatim}
